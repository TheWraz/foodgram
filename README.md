# Foodgram — Социальная сеть рецептов 🍽️
...
Проект полностью контейнеризирован, бэкенд написан на Django, фронтенд — на React.
...
- Просмотр рецептов на главной странице (пагинация, 6 рецептов на странице)
...
- Формирование списка покупок из выбранных рецептов
- Скачивание списка покупок в формате TXT
- Смена аватара профиля

### Для администраторов
- Управление пользователями, рецептами, тегами и ингредиентами
- Поиск по названию ингредиентов
- Фильтрация рецептов по тегам в админке
- Просмотр общего числа добавлений рецепта в избранное
